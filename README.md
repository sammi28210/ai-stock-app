{
    ...
    "5347.TWO": {"name": "世界", "group": "04. 晶圓代工與先進製程"},
...
with open("stocks.json", "w", encoding="utf-8") as f:
    json.dump(AI_STOCKS_DICT, f, ensure_ascii=False, indent=4)

st.success("stocks.json 檔案已產生！請將此檔案放入與 app.py 同個資料夾中，然後在 app.py 裡用 json.load() 讀取即可。")
